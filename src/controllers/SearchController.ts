...
async function testSuiteAggregationBuilder(req: express.Request) {
...
async function testCaseAggregationBuilder(req: express.Request) {
...
async function validationTagAggregationBuilder(req: express.Request) {
...
async function validationPointAggregationBuilder(req: express.Request) {
